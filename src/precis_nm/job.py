...
def build_prompt(
    ...
    return (
        ...
        "# Op vocabulary (realizes atoms into a fresh scratch scene) — every "
        "coordinate/offset/distance/bond_length below is Å, never metres "
        f"(the structure enclave; the envelope above is the one metre value)\n"
        f"{_OP_VOCAB}\n\n"
        "# Output contract\n"
