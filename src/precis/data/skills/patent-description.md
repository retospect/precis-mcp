...
Number paragraphs as prose in the bracketed form [0001], [0002], … in order. Refer to figures as "FIG. n" in prose and to other sections by `[dc…]`. Cite external corpus material as `[pc…]`. Managed numbering is an expansion (ADR 0037 §5); correctness is checked by a patent review pass (ADR 0037 §3a).
