...
named SI-conversion seams (the other is `precis_se`'s atomic mode
design↔atomistic boundary) — POSCAR/XYZ/CIF are Å-native file formats, so
today that seam is an identity conversion; a future SI-native export
format would convert here.
"""
