...
# [slug~N] (canonical), [slug›N] (legacy U+203A), or [slug#N] — a
# chunk reference is never a citation; the regex flags all three forms
# so the linter can rewrite them to ``[@slug]``.
