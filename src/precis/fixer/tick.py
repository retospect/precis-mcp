...
def _compose_prompt(item: WorkItem) -> str:
    return (
        ...
        "are: `CLAUDE.md`, `AGENTS.md`, `docs/codebase.md`, the owning "
        "package `__init__.py` docstring, and "
        "`src/precis/data/skills/precis-*-help.md`. This honours the "
        "docs/README.md norm: update the map in the same commit that changes "
        "what it describes.\n"
        "Do NOT force-update: the schema SVG, sealed migrations, or "
        "docs/backlog items your change did not ship.\n\n"
