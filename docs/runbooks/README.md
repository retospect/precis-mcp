...
- [`dead-mans-switch`](./dead-mans-switch.md) — `health_digest` (§D, `docs/backlog/health-watchdog.md`) covers every
...
- [`structure-roundtrip-eval`](./structure-roundtrip-eval.md) — **Status:** v1 (invariant tier). **Cadence:** run ~monthly as models and the
