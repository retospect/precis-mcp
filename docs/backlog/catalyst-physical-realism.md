...
> catalyst/autocatpath screening pipeline (`docs/backlog/autocatpath-integration.md`,
> `docs/backlog/catalyst-discovery-quest.md`) on top of the `structure` kind
...
- **Non-(111) facets, solvation, or other envelope work already tracked as
  out-of-scope in `docs/backlog/catalyst-discovery-quest.md` §9** — this
...
- The catalyst/autocatpath screening pipeline (quest `164903`,
  `docs/backlog/autocatpath-integration.md`, `docs/backlog/catalyst-discovery-quest.md`).
...
- The catalyst-discovery quest's frontier/ranking logic
  (`docs/backlog/catalyst-discovery-quest.md` §7.2-7.3) — poison resistance
...
- **Ensemble sample size vs. cost.** How many defect configurations per
  ...
  (`docs/backlog/autocatpath-integration.md` §3.4) is a plausible template but
