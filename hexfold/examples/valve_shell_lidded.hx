...
# the shell closed by a cap(12,0) lid on each neck: the first valve
# shell+lid pair; the rotor stays in lid_pillbox.hx (a multi-block file
# loses euler.residual today, see check.py consumed heuristic)
...
neck_a.in --fuse k=0--> lid_a.in
neck_b.out --fuse k=0--> lid_b.in
